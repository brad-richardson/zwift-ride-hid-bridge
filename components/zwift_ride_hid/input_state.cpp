...
constexpr DigitalBinding kDigitalBindings[] = {
    ...
    {0x000100UL, InputAction::BUTTON_Z},
    {0x000200UL, InputAction::LEFT_SIDE_UPPER},
    {0x000400UL, InputAction::LEFT_SIDE_MIDDLE},
    {0x000800UL, InputAction::LEFT_SIDE_LOWER},
    {0x001000UL, InputAction::LEFT_POWER},
    {0x002000UL, InputAction::RIGHT_SIDE_UPPER},
    {0x004000UL, InputAction::RIGHT_SIDE_MIDDLE},
    {0x010000UL, InputAction::RIGHT_SIDE_LOWER},
    {0x020000UL, InputAction::RIGHT_POWER},
};
